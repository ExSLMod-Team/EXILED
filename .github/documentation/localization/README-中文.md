...
# Windows
### 全自动安装 ([更多消息](https://github.com/ExSLMod-Team/EXILED/blob/master/EXILED/Exiled.Installer/README.md))
**备注**: 在运行安装包前请确保你所使用的用户有管理员权限。

  - 下载 **[Exiled.Installer-Win.exe](https://github.com/ExSLMod-Team/EXILED/releases)** (点击 Assets -> 下载安装包)
...
### 手动安装
  - 下载 **[Exiled.tar.gz](https://github.com/ExSLMod-Team/EXILED/releases)**
...
# Linux
### 全自动安装 ([更多信息](https://github.com/ExSLMod-Team/EXILED/blob/master/EXILED/Exiled.Installer/README.md))

**备注:** 如果你正在一个远程服务器上安装EXILED，请确保你运行的.exe的用户和你运行SCP:SL服务器的一致

  - 下载 [Exiled.Installer-Linux](https://github.com/ExSLMod-Team/EXILED/releases) (点击 Assets -> 下载安装包)
...
### 手动安装
  ...
  - 下载 [Exiled.tar.gz](https://github.com/ExSLMod-Team/EXILED/releases) (SSH: 右键获取 `Exiled.tar.gz` 的链接， 然后输入: **`wget (下载链接)`**)
